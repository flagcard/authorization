...
describe('Credentials', () => {
  it('should return default user_id for a non production environment', () => {
    sandbox.stub(environment, 'isProduction').returns(false);
    const req = {};
